...
function team_custom_init()
{
 ...
 $args = array(
  ...
  $labels = array(
    'name' => _x( 'Teams Category', 'taxonomy general name' ),
    ...
    register_taxonomy('teams_category',array('teams'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'query_var' => true,
...
/****************************custom post type for Inventory*********/
add_action('init', 'inventory_custom_init');  
 
/*-- Custom Post Init Begin --*/
function inventory_custom_init()
{
  $labels = array(
 ...
 $args = array(
  ...
  // The following is the main step where we register the post.
  register_post_type('our-inventory',$args);
   
  // Initialize New Taxonomy Labels
  $labels = array(
    'name' => _x( 'Inventory Category', 'taxonomy general name' ),
    'singular_name' => _x( 'Inventory Category', 'taxonomy singular name' ),
    'search_items' =>  __( 'Search Types' ),
    'all_items' => __( 'All Inventory Category' ),
    'parent_item' => __( 'Parent Inventory Category' ),
    'parent_item_colon' => __( 'Parent Inventory Category:' ),
    'edit_item' => __( 'Edit Tags' ),
    'update_item' => __( 'Update Inventory Category' ),
    'add_new_item' => __( 'Add New Inventory Category' ),
    'new_item_name' => __( 'New Inventory Category Name' ),
  );
    // Custom taxonomy for Project Tags
    register_taxonomy('inventory_category',array('our-inventory'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'query_var' => true,
...
/****************************custom post type for Inventory*********/
add_action('init', 'document_custom_init');  
 
/*-- Custom Post Init Begin --*/
function document_custom_init()
{
  $labels = array(
    'name' => _x('My Document', 'post type general name'),
    'singular_name' => _x('My Document', 'post type singular name'),
    'add_new' => _x('Add New', 'My Document'),
    'add_new_item' => __('Add New My Document'),
    'edit_item' => __('Edit My Document'),
    'new_item' => __('New My Document'),
    'view_item' => __('View My Document'),
    'search_items' => __('Search My Document'),
    'not_found' =>  __('No My Document found'),
    'not_found_in_trash' => __('No My Document found in Trash'),
    'parent_item_colon' => '',
    'menu_name' => 'My Document'
 ...
 $args = array(
  ...
  $labels = array(
    ...
    // Custom taxonomy for Project Tags
    register_taxonomy('document_category',array('my-document'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'query_var' => true,
